...
public class TestLine {
    public static void main(String[] args) {
        ...
        line1.setBegin(p2);  // Cambiar el punto de inicio
        line1.setEnd(p3);  // Cambiar el punto final
