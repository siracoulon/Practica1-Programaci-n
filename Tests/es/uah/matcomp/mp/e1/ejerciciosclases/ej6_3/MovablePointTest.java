...
class MovablePointTest {
    ...
    void testMoveUp() {
        ...
        movablePoint.moveUp();
        assertEquals(-1, movablePoint.toString().charAt(1), "La posición Y debería ser -1 después de mover hacia arriba.");
    }
    ...
    void testMoveDown() {
        ...
        assertEquals(1, movablePoint.toString().charAt(1), "La posición Y debería ser 1 después de mover hacia abajo.");
    }
    ...
    void testMoveLeft() {
        ...
        assertEquals(-1, movablePoint.toString().charAt(3), "La posición X debería ser -1 después de mover hacia la izquierda.");
    }
    ...
    void testMoveRight() {
        ...
        assertEquals(1, movablePoint.toString().charAt(3), "La posición X debería ser 1 después de mover hacia la derecha.");
    }
}
